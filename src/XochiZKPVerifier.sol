...
/// @notice Routes proof verification to per-proof-type UltraPlonk verifier contracts
...
contract XochiZKPVerifier is IXochiZKPVerifier {
    ...
    /// @notice Mapping from proof type ID to its UltraPlonk verifier contract
    ...
    /// @param verifier The UltraPlonk verifier contract address
    ...
    /// @dev Verify a single proof by routing to the appropriate UltraPlonk verifier
